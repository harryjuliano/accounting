            ...
            details: [
                {
                    ...
                    active: url === '/apps/cash-management' || url.startsWith('/apps/cash-management/dashboard'),
                    icon: <IconGauge size={20} strokeWidth={1.5} />,
                    permissions: accountingAccess,
                },
                {
                    title: 'Cash Receipt',
                    href: '/apps/cash-management/cash-receipts',
                    active: url.startsWith('/apps/cash-management/cash-receipts'),
                    icon: <IconCurrencyDollar size={20} strokeWidth={1.5} />,
                    permissions: accountingAccess,
                },
                {
                    title: 'Cash Payment',
                    href: '/apps/cash-management/cash-payments',
                    active: url.startsWith('/apps/cash-management/cash-payments'),
                    icon: <IconClipboardText size={20} strokeWidth={1.5} />,
                    permissions: accountingAccess,
                },
                {
                    title: 'Bank Transfer',
                    href: '/apps/cash-management/bank-transfers',
                    active: url.startsWith('/apps/cash-management/bank-transfers'),
                    icon: <IconArrowsTransferDown size={20} strokeWidth={1.5} />,
                    permissions: accountingAccess,
                },
                {
                    title: 'Cash & Bank Accounts',
                    href: '/apps/cash-management/accounts',
                    active: url.startsWith('/apps/cash-management/accounts'),
                    icon: <IconBook2 size={20} strokeWidth={1.5} />,
                    permissions: accountingAccess,
                },
                {
                    title: 'Petty Cash',
                    href: '/apps/cash-management/petty-cash',
                    active: url.startsWith('/apps/cash-management/petty-cash'),
                    icon: <IconChecklist size={20} strokeWidth={1.5} />,
                    permissions: accountingAccess,
                },
                {
                    title: 'Cash Advance',
                    href: '/apps/cash-management/cash-advances',
                    active: url.startsWith('/apps/cash-management/cash-advances'),
                    icon: <IconFileAnalytics size={20} strokeWidth={1.5} />,
                    permissions: accountingAccess,
                },
                {
                    title: 'Reimbursement',
                    href: '/apps/cash-management/reimbursements',
                    active: url.startsWith('/apps/cash-management/reimbursements'),
                    icon: <IconPercentage size={20} strokeWidth={1.5} />,
                    permissions: accountingAccess,
                },
                {
                    title: 'Bank Reconciliation',
                    href: '/apps/cash-management/bank-reconciliations',
                    active: url.startsWith('/apps/cash-management/bank-reconciliations'),
                    icon: <IconAdjustments size={20} strokeWidth={1.5} />,
                    permissions: accountingAccess,
                },
                {
                ...
                {
                    title: 'Cash Setup',
                    href: '/apps/cash-management/setup',
                    active: url.startsWith('/apps/cash-management/setup'),
