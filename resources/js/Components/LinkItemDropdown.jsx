                ...
                hasPermission ?
                    sidebarOpen ?
                        <>
                            ...
                            >
                                <div className='flex items-start gap-x-3.5 text-left'>
                                    {icon}
                                    <span className='whitespace-normal break-words leading-snug'>{title}</span>
                                </div>
                            ...
                            {isOpen && data.map((item, i) => (
                                <Link key={i} href={item.href} className={clsx(sideOpen, url === item.href && sideActive)}  {...props}>
                                    {item.icon}
                                    <span className='whitespace-normal break-words leading-snug'>{item.title}</span>
                                </Link>
                            ))}
                        </>
