...
class SalesInvoicePostingRuleSeeder extends Seeder
{
    ...
    {
        $this->ensureSupportingAccounts($company);
        ...
        $this->seedDefaultMappings($company, [
            ...
            'sales.invoice.debit.discount' => [
                'account_codes' => ['4130', '4120-020', '7130', '4120'],
    ...
    private function ensureSupportingAccounts(Company $company): void
    {
        $revenueGroupId = AccountGroup::query()
        ...
        $parentRevenueId = ChartOfAccount::query()
            ->where('company_id', $company->id)
            ->where('code', '4100')
            ->value('id');
        ...
        foreach ([
            [
                'code' => '4130',
                'name' => 'Sales Discount',
                'alias_name' => 'Diskon Penjualan',
                'normal_balance' => 'debit',
            ],
            [
                'code' => '4140',
                'name' => 'Freight Income',
                'alias_name' => 'Pendapatan Ongkos Kirim',
