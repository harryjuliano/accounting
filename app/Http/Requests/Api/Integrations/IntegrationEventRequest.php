...
class IntegrationEventRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payload.source_module_name' => ['nullable', 'string', 'max:255'],
            'payload.counterparty_type' => ['nullable', 'string', 'max:255'],
            'payload.counterparty_code' => ['nullable', 'string', 'max:255'],
            'payload.counterparty_name' => ['nullable', 'string', 'max:255'],
            'payload.salesperson_code' => ['nullable', 'string', 'max:255'],
            'payload.salesperson_name' => ['nullable', 'string', 'max:255'],
            ...
            'payload.journal.lines.*.item_code' => ['nullable', 'string', 'max:255'],
            'payload.journal.lines.*.item_name' => ['nullable', 'string', 'max:255'],
            'payload.journal.lines.*.quantity' => ['nullable', 'numeric', 'min:0'],
            'payload.journal.lines.*.quantity_uom' => ['nullable', 'string', 'max:50'],
